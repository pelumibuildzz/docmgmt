        ...
        <div className="col-span-7">
            <div className={`${poppins.className} bg-white w-full flex flex-col min-h-screen`}>
                ...
                <main className="w-full p-6 flex flex-col space-y-11 max-w-[900px]">
                    ...
                    <div className="flex flex-col space-y-10 mt-14">
                        <div className="flex flex-col space-y-2">
                            ...
                            <div className="text-end px-4">
                                <button className="px-2 py-1 rounded-xl border-[.5px] border-gray-300 text-primary text-[14px]">Edit</button>
                            </div>
                        </div>
                        <div className="flex flex-col space-y-2">
                    ...
                    <button className="text-white bg-primary rounded-xl font-medium text-[16px] px-4 py-3 w-fit self-end mx-10 my-8">Save Changes</button>
            </div>
        </div>
      </div>
    </div>
