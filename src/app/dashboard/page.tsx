    ...
    <div className={`${poppins.className} bg-white w-full flex flex-col min-h-screen`}>
      ...
      <main className="w-full p-10 flex flex-col space-y-11">
        ...
        <section className="flex flex-col space-y-[38px] w-full">
          {/* Filters */}
          <div className="bg-primary-lighter px-8 py-4 flex items-center justify-between rounded-2xl w-fulltext-[16px] border-[.5px] border-gray-300">
            ...
            <div className="flex space-x-4 text-gray">
              <div>
                ...
                <input type="date" className="p-2 rounded-xl border border-gray-300" />
              </div>
              <div>
          ...
          {/* Dashboard View */}
          <div className="p-8 border-[.5px] border-gray-300 w-full grid grid-cols-4 gap-x-7 gap-y-10 rounded-xl">
            ...
            <Link href={"/dashboard/doc-mgmt?filter=assigned"} className="col-span-1 py-5 px-4 flex flex-col space-y-3 rounded-xl bg-docbg-archived">
            ...
            <Link href={"/dashboard/doc-mgmt?filter=due_today"} className="col-span-1 py-5 px-4 flex flex-col space-y-3 rounded-xl bg-docbg-due-today">
            ...
            <Link href={"/dashboard/doc-mgmt?filter=updated"} className="col-span-1 py-5 px-4 flex flex-col space-y-3 rounded-xl bg-docbg-updated">
            ...
            <Link href={"/dashboard/doc-mgmt?filter=archived"} className="col-span-1 py-5 px-4 flex flex-col space-y-3 rounded-xl bg-docbg-archived">
            ...
            <Link href={"/dashboard/doc-mgmt?filter=pending"} className="col-span-1 py-5 px-4 flex flex-col space-y-3 rounded-xl bg-docbg-pending">
            ...
            <Link href={"/dashboard/doc-mgmt?filter=ongoing"} className="col-span-1 py-5 px-4 flex flex-col space-y-3 rounded-xl bg-docbg-ongoing">
            ...
            <Link href={"/dashboard/doc-mgmt?filter=completed"} className="col-span-1 py-5 px-4 flex flex-col space-y-3 rounded-xl bg-docbg-complete">
